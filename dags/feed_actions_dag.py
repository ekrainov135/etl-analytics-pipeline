...
from utils.sql import FEED_ACTIONS_CREATE, DROP_TABLE
...
def feed_actions_dag():
    ...
    table = 'test.feed_actions'
    db_reset_sql = [DROP_TABLE.format(table=table), FEED_ACTIONS_CREATE]
    ...
    params_default = {'source': 'feed_actions.parquet', 
    ...
    run_feed_actions_task = run_feed_actions(ctl_init_task)
    run_feed_actions_task.set_upstream(context_init_task)
    ctl_update_task = ctl_update(run_feed_actions_task)


feed_actions_dag = feed_actions_dag()
